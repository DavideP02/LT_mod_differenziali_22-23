...
\end{align*}
Consideriamone adesso il vettore tangente che, per definizione di sistema dinamico, è:
\begin{align*}
...
\end{align*}
dove il membro a destra è un piano di contatto.
...
\end{align*}
Creando cosi una coppia $\left\{\bm{t}_1,\bm{t}_2\right\}$ di vettori ortonormali.
...
Esistono solo curve integrali di dimensione 1 dal teorema di Frobenius
