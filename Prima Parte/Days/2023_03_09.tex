...
\teorema[Teorema di dipendenza continua dai dati iniziali]{fsglkjnsdfglkjnsdflgkjnsdflkgjnsdflkgjjjfjfjfjfjfifroiefdfdskjncdskujhsdfalkjandxvberure}{
    ...
    Sia $ I_{\max}  $ l'intervallo massimale di $ \bm{u}_{(t,\bm{x}_0)} $ e $ [a,b] \subset I_{\max}  $. Allora: \begin{enumerate}
...
\osservazione{
   ...
   Il teorema afferma di più: la successione $ \left\{\bm{u}_{(t,\bm{x}_k)}\right\}_{k} $ converge non solo puntualmente, ma bensì uniformemente su $ [a,b] $.
}
