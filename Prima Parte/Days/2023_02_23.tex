...
\paragrafo{Pennello di Peano}{%
    ...
    Questo fenomeno, denominato \ul{pennello di Peano}, è reso evidente dal seguente
}{}{}
\esempio{
...
\dimostrazione{ldksnaflkjnadflkjadnsflajknkljndasf}{
    La dimostrazione si articola nei seguenti passaggi: \begin{itemize}
        \item si considera l'\emph{equazione di Volterra} \[
            \bm{u}(t)= \bm{x}_0 + \int_{t_0}^{t} \bm{f}\left(s,\bm{u}(s)\right)\,ds
        ...
        \item la seguente successione \[
            \bm{u}_0(t) \equiv \bm{x}_0,\qquad \bm{u}_n(t) = \bm{x}_0 + \int_{t_0}^{t} \bm{f}\left(s,\bm{u}_{n-1}(s)\right)\,ds,\qquad \forall\, n \in \N
