...
\paragrafo{Studio delle soluzioni}{%
    ...
    \begin{enumerate}
        \item Prima di tutto cerchiamo le soluzioni costanti, ovvero quelle tali che $ f(p)=0$. Queste sono due soluzioni costanti per ogni tempo $t$: $p(t)\equiv 0 $ e $ p(t)\equiv (k/h) $.
    ...
    \item $ p_0>k/h $: la soluzione è sempre monotona decrescente, e si troverà sempre nel semispazio $ p>k/h $. Anche in questo caso si applica il corollario \framref{dakfjhbaksjdhfbaksjdhfbakjhbkjhb} 
